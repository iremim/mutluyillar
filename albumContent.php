            ...
            echo' <html lang="en">
                    ...
                    <body>
                        <div id="titleBox">
                            ...
                            <h1 style="font-family:'; echo "'Kaushan Script'"; echo', cursive; font-weight:bold; font-size:25px; width: 34vh;text-align: center;"><a style="text-decoration: none;color: white;">'; echo $album; echo'</a></h1>
